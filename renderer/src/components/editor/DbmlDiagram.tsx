...
export const DbmlDiagram = forwardRef<HTMLDivElement, { schema: DbmlSchema; onScroll?: (() => void) | undefined }>(
              ...
              >
                ...
                <div className="divide-y divide-[var(--cf-border)]">
                  {table.columns.map((col) => (
                    <div key={col.name} className="flex items-center justify-between gap-2 px-2.5 py-1 text-badge">
